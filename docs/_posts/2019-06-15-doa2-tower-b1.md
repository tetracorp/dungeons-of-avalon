...
* 1-5 groups of 1-6 Voodoo Man, Alien, or Zombi

### Monster statistics

| Name            |  HP | Damage  | Atk |SpAtk|Stat|    XP |Gold |
|-----------------|-----|---------|-----|-----|----|-------|-----|
| Alien           |  35 |   25-28 |   5 |   5 |    |   240 |   5 |
| Voodoo Man      |  30 |   19-22 |   5 |   4 |    |   196 |  50 |
| Zombi           |  48 |   20-23 |   6 |   5 | PO |   272 |  10 |
...
* There are a lot of pits on this level: 430 type 0, five type 05, seven type
  83, and two type 84, for 444 total. The only other level in the entire series
  to use pits is level 1 of the tower, which uses three. Falling into a pit will
  merely teleport you back to the start of the level. There's a start point
  marker in the level just to let the game know where to send the party when
  they fall down a pit. The pit block subtype appears to have no special effect,
  and does not appear necessary to beat the level.
