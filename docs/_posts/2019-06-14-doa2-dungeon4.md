...
|----|-------------|--------|-------------|
| 00 | X: 15 Y: 07 |     01 | X: 08 Y: 21 |
| 01 | X: 08 Y: 21 |     00 | X: 15 Y: 07 |

Number shown on map is the target teleporter ID. All teleporters on this level
are bi-directional (this is easy, as there are only two).
...
* 1-4 groups of 1-4 Voodoo Man, Alien, or Zombi
