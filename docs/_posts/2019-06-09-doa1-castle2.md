...
* 1-3 groups of 1-4 Silly Walker, Magician, or Silly Guard

### Monster statistics

| Name            |  HP | Damage  | Atk |SpAtk|Stat|    XP |Gold |
|-----------------|-----|---------|-----|-----|----|-------|-----|
| Magician        |  50 |   15-18 |   7 |   6 | BL |   260 |  15 |
| Silly Guard     |  55 |   25-28 |   7 |   7 |    |   320 |   5 |
| Silly Walker    |  45 |   20-23 |   7 |   6 |    |   260 |  90 |

* Magician can cast Acid Breath (28-36 damage to all).
...
* This is the only level in the game where you won't encounter Worms, because
  there are no fied encounters.
