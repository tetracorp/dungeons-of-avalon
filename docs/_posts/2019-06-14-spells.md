...
6. Anti-Aura and Killmagic can only be found as scrolls.
12. Teleport appears to be unavailable. It does not appear on the spell list for
...
9. Scrolls of 17 spells can be found in _Dungeons of Avalon II_:
...
10. Killmagic is used in _Dungeons of Avalon II_ to disable magic walls
...
11. All classes have exactly two spells per level. The exception is in the first
...
3. The Magician gets Magic Armour2 (Hexer R&uuml;stung) instead of
   Magic Armour. However, the original Magic Armour can still be found
   as a spell scroll.
