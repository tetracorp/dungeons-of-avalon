...
|----|-------------|--------|-------------|
| 00 | X: 07 Y: 20 |     01 | X: 10 Y: 22 |
| 01 | X: 10 Y: 22 |     00 | X: 07 Y: 20 |

Number shown on map is the target teleporter ID. All teleporters on this map are
bi-directional (easy, since there are only two).
...
* 1-4 groups of 1-5 Fire Troll, Arc Dragon, or Skelleton
...
| Fire Troll      |  65 |   25-28 |   7 |   7 |    |   360 |  50 |
